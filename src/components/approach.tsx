...
export default function Approuch() {
  return (
    <div
      id="approach"
      className="flex w-full flex-col items-center justify-center bg-black pb-[3.125rem] "
    >
      ...
      <div className="flex flex-col items-center justify-center gap-[7.625rem] pb-[5.125rem] md:flex-row md:items-start">
        <div className="flex max-w-[14.938rem] flex-col items-center ">
          <p className="mb-[0.813rem] text-center text-[1.5rem] leading-[1.625rem] text-white md:text-[1.625rem] md:leading-[1.688rem] md:tracking-[-0.016rem]">
            Aplicativos e <strong>Sistemas</strong>
          </p>
          <img src="/images/sites.svg" className="mb-[1.438rem] h-[5rem]" />
        ...
        <div className="flex max-w-[14.938rem] flex-col items-center">
          <p className="mb-[0.813rem] break-words text-center text-[1.5rem] leading-[1.625rem] text-white md:text-[1.625rem] md:leading-[1.688rem] md:tracking-[-0.016rem]">
            Sites e <strong>E-commerces</strong>
          </p>
          <img
            src="/images/aplicativos.svg"
            className="mb-[1.438rem] h-[5rem]"
          />
          <p className="mb-[1.313rem] text-left text-[0.938rem] font-normal leading-[1.188rem] text-[#bdbebd] md:mb-[0.75rem] md:h-[5.5rem] md:text-[1.125rem] md:leading-[1.25rem] md:tracking-[-0.011rem]">
        ...
        <div className="flex max-w-[14.938rem] flex-col items-center">
          <p className="mb-[0.813rem] w-[70%] text-center text-[1.5rem] leading-[1.625rem] text-white md:text-[1.625rem] md:leading-[1.688rem] md:tracking-[-0.016rem]">
            Mídia e <strong>Design</strong>
          </p>
          <img src="/images/sistemas.svg" className="mb-[1.438rem] h-[5rem]" />
