export default function Approuch() {
  return (
    <div className="bg-gradient-to-br from-[#1D4D9D] to-[#86B3FF] flex w-full justify-center flex-col items-center">
      <div className="pt-[3rem] pb-[3.688rem] w-full flex justify-center">
        <p className="text-white text-center md:text-[2.188rem] md:leading-[2.625rem] md:max-w-[37.063rem] text-[1.8rem] leading-[2.2rem] md:text-left font-bold md:font-normal w-[90%]  md:w-[45rem]">
          Transformamos ideias em experiências digitais memoráveis
        </p>
      </div>
      <div className="flex flex-col items-center md:flex-row gap-[1.875rem] ">
        <div className="bg-[#1D4D9D] py-[0.5rem] w-[90%] rounded-[10px] flex flex-col gap-[0.8rem] items-center">
        ...
        <div className="bg-[#1D4D9D] mb-[2.625rem] py-[0.5rem] w-[90%] rounded-[10px] flex flex-col gap-[0.8rem] items-center">
          <p className="text-[#FF465D] text-center md:text-[2.188rem] md:leading-[2.625rem] text-[1.6rem] leading-[2.2rem] md:text-left font-bold md:font-normal w-[90%]">
            Design Intuitivo
          </p>
          <p className="text-white w-[80%] text-center text-[0.938rem] leading-[1.188rem] md:text-[1.125rem] md:leading-[1.375rem] md:h-[5.5rem] mb-[1.313rem] md:mb-[0.75rem]">
